...
#define REQ_CODE_INV -10

/* ---- DISCLAIMER ----
    The following functions are already thread safe. This may not be necessary
    for some applications, but it was considered to be a good practice to
    already prepare the functions for applications where it would be needed
*/
